...
public class RetirarDineroAdminController {
	 ...
	 * dinero
	 */
	private Cliente cliente = MetodosBanco.retirarDinero();
    ...
    void btnRetirarDineroEvent(ActionEvent event) {
    	...
    	Double dineroDelCliente = MetodosBanco.banco.getCliente().getDefCuenta().getSaldo();
    	...
    	if(this.txtDineroDepositar.getText().equals("")) {
    		...
    		if(verificarDinero(dineroRetirar)) {
        		...
        		Double retirarDinero = MetodosBanco.banco.getCliente().getDefCuenta().setSaldo(dineroDelCliente - dineroRetirar);
  ...
  //__________________________________________________________________
    ...
    private void crearTransaccion(double dineroRetirar) {
    	...
    	MetodosBanco.realizarTransaccion(transaccionNueva);
  ...
  //__________________________________________________________________
	...
	private boolean verificarDinero(double dineroRetirar) {
    	...
    	if(dineroRetirar <= MetodosBanco.banco.getCliente().getDefCuenta().getSaldo()) {
    		return true;
    	}
		return false;
	}
