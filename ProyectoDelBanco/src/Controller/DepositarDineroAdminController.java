...
public class DepositarDineroAdminController {
	 ...
	 */
	private Cliente cliente = MetodosBanco.depositarDineroCuenta();
    ...
    void btnDepositarDineroEvent(ActionEvent event) {
    	...
    	if(this.txtDineroDepositar.getText().equals("")) {
        	...
        	Double dinero = MetodosBanco.banco.getCliente().getDefCuenta().getSaldo();
        	
        	Double agregarDinero = MetodosBanco.banco.getCliente().getDefCuenta().setSaldo(dinero + txtDineroDepositar);
