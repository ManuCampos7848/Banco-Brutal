...
public class LoginClienteController {
	...
	void logearEvent(ActionEvent event) {
		...
		if(MetodosBanco.banco.loginClientes(correo, contrasenia)) {

			Cliente obtenerCliente = MetodosBanco.banco.obtenerObjetoClienteContrasenia(contrasenia);
			...
			MetodosCuenta.banco.setCliente(obtenerCliente);
